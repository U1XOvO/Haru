...
function make(overrides={}){
 const state={record:false,busyCount:0,chatBusy:false,studyGeneration:false,studyGenerationCancelling:false,
...
for(const state of [{record:true},{chatBusy:true},{busyCount:1},{dailyWordLoading:true},{studyGeneration:true},{studySaveFailed:true},{pending:new Map([[1,{}]])},{studyAttempt:{status:'active'}}]){
